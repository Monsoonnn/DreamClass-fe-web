...
export default function RankingTable() {
  ...
  const columns = [
    ...
    { title: 'Mã học sinh', dataIndex: 'studentCode', align: 'center' },
    ...
    { title: 'Ghi chú', dataIndex: 'note', align: 'left', ellipsis: true },
    {
      ...
      render: (_, record) => (
        <Space>
          <Button type="primary" icon={<EyeOutlined />} onClick={() => navigate(`/ranking-mana/view/${record.key}`)}>
            Xem
          </Button>
        </Space>
      ),
  ...
  return (
    <div className="bg-gray-50 p-2">
      <h1>
        {' '}
        <span className="text-2xl font-bold text-gray-800 p-4 select-none">Bảng xếp hạng</span>{' '}
      </h1>
