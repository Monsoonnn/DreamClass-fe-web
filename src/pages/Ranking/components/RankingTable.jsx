...
import { Table, Tag, Button, Space, Input, Pagination, Card, Avatar, Image, message, Spin } from 'antd';
    ...
    <Spin spinning={loading}>
      <div className="bg-white p-4">
        <div className="flex items-center gap-2 mb-6">
          <h1 className="text-2xl font-bold text-gray-800 m-0">{isTeacher && className ? `Bảng xếp hạng lớp ${className}` : 'Bảng xếp hạng theo lớp'}</h1>
