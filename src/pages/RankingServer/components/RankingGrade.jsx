...
import { Table, Tag, Button, Space, Select, Pagination, Card, Avatar, Image, Breadcrumb, Spin } from 'antd';
import { EyeOutlined, FileExcelOutlined, SearchOutlined, TrophyOutlined, TeamOutlined } from '@ant-design/icons';
        ...
        {loading ? (
          ...
          <>
            <div className="flex items-center gap-2 mb-4">
              ...
              {isTeacher && grade && <Tag color="blue">Khối {grade} (Được phân công)</Tag>}
            </div>

            {/* INPUT KHỐI - ẨN VỚI GIÁO VIÊN */}
            {!isTeacher && (
