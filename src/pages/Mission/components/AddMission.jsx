  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const payload = {
        ...
        isDailyQuest: values.isDailyQuest || false,
      ...
      <div className="p-2 rounded-md flex justify-center">
        <div className="bg-white p-4 rounded shadow-md w-full max-w-3xl">
          {loading ? (
            ...
            <Form layout="vertical" form={form} onFinish={handleSubmit} disabled={submitting}>
              {/* I. Thông tin chung */}
